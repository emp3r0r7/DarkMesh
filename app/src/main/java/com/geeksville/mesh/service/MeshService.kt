...
import org.meshtastic.proto.Portnums.PortNum.TEXT_MESSAGE_COMPRESSED_APP_VALUE
    ...
    private fun rememberDataPacket(dataPacket: DataPacket, updateNotification: Boolean = true) {
        ...
        serviceScope.handledLaunch {
            ...
            packetRepository.get().apply {
                ...
                val isChatMessage = dataPacket.dataType == TEXT_MESSAGE_COMPRESSED_APP_VALUE ||
                        dataPacket.dataType == TEXT_MESSAGE_APP_VALUE
